...
namespace SplashKitSDK
{
  public static class SplashKit
  {
    ...
    public static void FillCircle(Color clr, float x, float y, Circle c)
    {
      __sklib_color __skparam__clr;
      __sklib_circle __skparam__c;
      __skparam__clr = __skadapter__to_sklib_color(clr);
    ...
    public static void FillCircle(Color clr, float x, Circle c, DrawingOptions opts)
    {
      __sklib_color __skparam__clr;
      __sklib_circle __skparam__c;
      __sklib_drawing_options __skparam__opts;
    ...
    public static void FillCircle(Color clr, double x, double y, double radius, int height)
    {
      __sklib_color __skparam__clr;
      double __skparam__x;
      double __skparam__y;
    ...
    public static int WindowY(Window wnd)
    {
      ...
      return __skadapter__to_int(__skreturn);
        ...
        internal static void FillCircle(Color color, float x, float y, int radius)
        {
